    ...
    <div className="w-full mx-auto rounded-t-3xl mt-[-20%] z-10">
      <div className="w-[80%] mx-auto bg-white rounded-t-3xl p-4 px-6">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <Button className="outline-[#F26922] bg-[#F26922] border-[#F26922] text-xs sm:text-sm h-10 sm:h-12 px-4 sm:px-6">
            Airport Parking
          </Button>
          <Button
            className="outline-[#F26922] text-[#F26922] border-[#F26922] text-xs sm:text-sm h-10 sm:h-12 px-4 sm:px-6"
            variant={"outline"}
          >
            Hotel & Parking
          </Button>
          ...
          <Button
            className="outline-[#F26922] text-[#F26922] border-[#F26922] text-sm h-10 sm:h-12 px-4 sm:px-6"
            variant={"outline"}
          >
            Airport Transfer
          </Button>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 container bg-white rounded-3xl shadow-lg p-6 sm:p-9">
            ...
            <div className="flex justify-center items-center sm:col-span-3 ml-[1000px] mt-[-110px]">
              <Button
                type="submit"
                className="bg-[#F26922] text-white hover:bg-[#F26922] rounded-md py-2 px-6 w-[150px]"
              >
                Get Quote
              </Button>
            </div>
