...
const AboutUs = () => {
  return (
    ...
    <div className="container flex justify-center items-center">
      ...
      <div className="relative w-[40%] h-[85vh] ml-[50px]"> {/* Height set to 50% of the viewport height */}
      <div className="absolute top-[-10%] left-[-40%]">
            <img
              src="/Ellipse 18.png"
              alt="Decorative"
              className="object-contain h-[850px]"
            />
          </div>
          <Image src={"/office.png"} layout='fill' className='rounded-xl w-[20px]' objectFit="cover" alt="Office" />
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center p-4 sm:p-8 space-y-6 ml-[25px]"> {/* Added space-y-6 for more spacing */}
            ...
            <button className="bg-[#F26922] w-fit mt-6 text-white px-3 sm:px-4 py-1 sm:py-2 rounded-md h-[50px]"> {/* Changed to rounded-full */}
              Our Parking Options
