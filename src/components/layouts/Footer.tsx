...
const Footer = () => {
  return (
    <footer className="mt-[50px] bg-black text-white py-10 text-xs sm:text-sm">
      <div className="container mx-auto px-6 lg:px-20 flex flex-col gap-6">
        ...
        <div className="space-y-4 md:flex items-center justify-between">
          ...
          <div className="flex items-center md:w-[40%] mt-4 md:mt-0">
            ...
            />
            <button className="bg-[#F26922] p-3 rounded-md border-2 border-transparent focus:border-white focus:outline-none ml-[-10px] w-[40%] text-white">SUBSCRIBE</button>
          </div>
        </div>
